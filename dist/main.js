    ...
    var O = "LAND",
      ...
      A = function (t, e) {
        var i = e.string,
          ...
          c = 0.1 * h;
        o.save(), o.beginPath();
        var d = o.createLinearGradient(0, 0, 0, s);
        d.addColorStop(0, "#FAD961"),
          d.addColorStop(1, "#F76B1C"),
          (o.fillStyle = d),
          (o.lineWidth = c),
          (o.strokeStyle = "#FFF"),
          (o.textAlign = n || "center"),
          (o.font = "".concat(h, "px ").concat("wenxue")),
          o.strokeText(i, r, s),
          o.fillText(i, r, s),
          o.restore();
      },
        ...
        !(function (t) {
          ...
          (function (t) {
            ...
            r > t.height ||
              ...
              t.getTimeMovement("BG_INIT_MOVEMENT", [[r, r + a / 4]], function (
                t
              ) {
                r = t;
              }),
